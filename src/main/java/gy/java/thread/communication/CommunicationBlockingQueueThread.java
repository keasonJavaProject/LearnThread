package gy.java.thread.communication;
import java.util.concurrent.CountDownLatch;

/**
 * Created by KEASON on 2017/5/11.
 */
public class CommunicationBlockingQueueThread {
    ...
    public static void main(String[] args) throws InterruptedException {
        CommunicationBlockingQueueThread thread = new CommunicationBlockingQueueThread();
